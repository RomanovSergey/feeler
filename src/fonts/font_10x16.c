...
FON2_T f2_0x20[10] = { 0x0000,0x0000, 0x0000,0x0000, 0x0000,0x0000, 0x0000,0x0000, 0x0000,0x0000, }; //' '
...
FON2_T f2_0x41[10] = { 0x3FFC,0x3FFC, 0x0303,0x0303, 0x0303,0x0303, 0x0303,0x0303, 0x3FFC,0x3FFC, }; // A
FON2_T f2_0x3F[10] = { 0x000C,0x000C, 0x0003,0x0003, 0x3303,0x3303, 0x00C3,0x00C3, 0x003C,0x003C, }; // ?
FON2_T f2_0x45[10] = { 0x3FFF,0x3FFF, 0x30C3,0x30C3, 0x30C3,0x30C3, 0x30C3,0x30C3, 0x3003,0x3003, }; // E

FON2_T f2_0x69[10] = { 0x0000,0x0000, 0x3030,0x3030, 0x3FF3,0x3FF3, 0x3000,0x3000, 0x0000,0x0000, }; // i
FON2_T f2_0x72[10] = { 0x3FF0,0x3FF0, 0x00C0,0x00C0, 0x0030,0x0030, 0x0030,0x0030, 0x00C0,0x00C0, }; // r
