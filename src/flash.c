 ...
 *
 *   Число записей с различными ID должно быть ограничено, иначе в после переключения
 * с одного блока на другой, свободного пространства может быть вновь не достаточным.
 *
 *   Под начало блока забираем 4 байта, в которой будет хранится следующая информация:
 *   - 0xFFFF 0xFFFF - пустой блок
 *   - 0xBBBB 0xBBBB - текущий блок
 *   - 0x0000 0x0000 - в процессе переключения с данного блока на пустой блок
 */
